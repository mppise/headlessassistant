...
| `_DEMO/agent-server/lib/system-prompt.txt` | C03-F09 — loaded at startup |
...
> The Python server reads these shared files from the Node.js tree via relative paths. It does **not** duplicate them.
